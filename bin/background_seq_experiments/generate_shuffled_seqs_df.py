...
def main():
    ...
    parser.add_argument('--output_filename', dest='output_filename', default='data/shuffled_seqs_human.tsv', help='output_filename')
    parser.add_argument('--shuffle_parameter', nargs='+', default=[2,4,8], type=int, help='List of integers')
    parser.add_argument('--ctcf_selection_threshold', default=[8,16], nargs='+', type=int, help='List of integers')
    parser.add_argument('--mutation_method', nargs='+', default=['permute_whole_seq','randomise_whole_seq'], help='List of strings')
