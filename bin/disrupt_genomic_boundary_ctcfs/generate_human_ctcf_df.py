...
def main():
    ...
    parser.add_option(
        "--jaspar-file",
        dest="jaspar_file",
        default="/project/fudenber_735/motifs/hg38/jaspar/MA0139.1.tsv.gz",
        help=" [Default: %default]",
    )
    parser.add_option(
        "--chrom-sizes-file",
        dest="chrom_sizes_file",
        default="/project/fudenber_735/genomes/hg38/hg38-chromsizes.tsv",
        help=" [Default: %default]",
    )
    ...
    parser.add_option(
        "--boundary-file",
        dest="boundary_file",
        default="/project/fudenber_735/GEO/Krietenstein2019/sameer_remap/features/U54-HFFc6-FA-DSG-MNase-R1-R3.hg38.mapq_30.10000.window_200000.insulation",
        help=" [Default: %default]",
    )
    parser.add_option(
    ...
    parser.add_option(
        ...
        default="boundaries.motifs.ctcf.hg38.tsv",
        type="str",
    ...
    boundaries = boundaries.loc[True == (boundaries["is_boundary_200000"] == True)]
    ...
    df_out.to_csv(f"1_{options.boundary_output_tsv}", sep="\t", index=False)
    print("saved")
