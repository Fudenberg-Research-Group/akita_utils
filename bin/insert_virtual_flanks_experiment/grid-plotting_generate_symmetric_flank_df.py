...
def main():
    ...
    df_with_flanks_spacers = add_flanks_and_spacers(
        df_with_background, flanks_list, options.flank_spacer_sum
    )
...
def validate_df_lenght(num_orientations, num_backgrounds, num_flanks, df):

    expected_df_len = 1 * num_orientations * num_backgrounds * num_flanks
...
def add_flanks_and_spacers(seq_coords_df, flank_list, flank_spacer_sum):
