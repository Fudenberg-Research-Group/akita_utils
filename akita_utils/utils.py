...
def create_flat_seqs(seqnn_model, genome_fasta, site_df, seq_length, max_iters = 1, batch_size = 6, shuffle_k = 8, ctcf_thresh = 8, scores_thresh = 5500, scores_pixelwise_thresh = .04 ):
    '''
