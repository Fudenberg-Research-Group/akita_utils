...
use lib qw(/home1/smaruj/meme/lib/meme-5.5.4/perl);
...
unless ($@) {
  Log::Log4perl::init('/home1/smaruj/meme/share/meme-5.5.4/logging.conf');
  $logger = Log::Log4perl->get_logger('meme.service.utils');
}

my $service_invocation_log_dir = '/home1/smaruj/meme/var/meme-5.5.4/LOGS';
my $tmpdir = '';
...
sub update_status {
  ...
  my $template = HTML::Template->new(filename => '/home1/smaruj/meme/share/meme-5.5.4/job_status.tmpl');
