...
tsv_file="/home1/smaruj/akita_utils/experiments/insert_virtual_dots_vs_boundaries/ctcf_tsv/dot_filtered_mismatched_ctcf.tsv"
out_dir="/scratch2/smaruj/dot_OUT" 
